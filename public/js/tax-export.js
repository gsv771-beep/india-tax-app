...
export async function buildTaxWorkbookBase64(inputs, cmp, rates, flags, who = '', ExcelJSLib = null) {
  ...
  const rows = [
    ...
    ['Income comes from', inp.incomeType || 'salary'], ['Business / professional receipts', inp.business.receipts], ['Profession or business', inp.business.kind], ['Presumptive scheme', inp.business.presumptive === false ? 'No' : 'Yes'], ['Digital share of turnover (%)', inp.business.digitalSharePct, '0'], ['Business expenses (books)', inp.business.expenses], ['TDS already deducted', inp.business.tdsDeducted], ['Business / professional income (net, typed)', inp.business.income], ['Savings interest', inp.otherIncome.savingsInterest], ['FD / RD interest', inp.otherIncome.depositInterest], ['Dividends', inp.otherIncome.dividends], ['Other income', inp.otherIncome.other],
