...
- **Calculators**:
  ...
  - Retirement: five figures (age, retire at, monthly spending, saved so far, saving per month) and one sentence back: the money lasts past 85, or runs out at age X and this much more a month closes the gap. Year-by-year chart, two sensitivities (retire two years later, inflation a point higher), assumptions folded with plain defaults. Deliberately simple: one growth rate, no withdrawal tax; says so. Engine `public/engine/retirement.js`.
